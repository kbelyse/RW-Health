    ...
    <div className={`flex items-center gap-2.5 ${className}`}>
      ...
      >
        ...
        >
          ...
          <path
            d="M20 22h24v4H20v-4zm0 8h24v3H20v-3zm8 8v12"
            stroke="url(#rwlg2)"
            strokeWidth="2.5"
            strokeLinecap="round"
          />
          <path
            d="M32 38c4 0 7-2.5 7-6s-3-6-7-6-7 2.5-7 6 3 6 7 6z"
            stroke="url(#rwlg2)"
            strokeWidth="2"
            fill="none"
          />
      ...
      {showWordmark && (
        <div className="min-w-0 leading-tight">
          <span
            className={`font-display font-semibold tracking-tight ${dark ? "text-white" : "text-brand-950"} ${s.text}`}
          >
            RW-Health
          </span>
          <span
            className={`block font-medium uppercase tracking-[0.2em] ${dark ? "text-brand-100/90" : "text-slate-500"} ${s.sub}`}
          >
            Passport
          </span>
        </div>
