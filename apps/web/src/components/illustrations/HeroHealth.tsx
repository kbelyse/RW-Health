export function HeroHealthIllustration({ className = "" }: {
    className?: string;
}) {
    return (<svg viewBox="0 0 480 360" className={className} fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <defs>
      ...
      <path d="M200 70c12 0 22 10 22 22 0 8-4 15-10 19 6 4 10 11 10 19v6h-44v-6c0-8 4-15 10-19-6-4-10-11-10-19 0-12 10-22 22-22z" fill="#dbeafe"/>
